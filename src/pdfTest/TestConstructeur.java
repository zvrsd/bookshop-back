package pdfTest;
	...
	public class TestConstructeur extends Document {
		...
		String f = "f"; 
		String g = "g"; 
		static Cell cell12 = new Cell("Quantit�"); 
	...
	public Cell[] data(String dateOrder, String nomPayeur, String nomLivreur, String modePaiement) {
...
public Cell[] dataT2(String quantite, String idProduit, String description, String prixU, String total) {
		...
		return cellD2 = new Cell [] {docell, pacell, nlcell, mpcell, tocell};
			...
			public static void main(String[] args) {
			    ...
			    try {
			      PdfWriter.getInstance(document, new FileOutputStream("D:\\DossierCharlene\\Librairie\\LibNetbeans/facture.pdf"));
			      document.open();
				  ...
				  document.add(vendeur);
				      ...
				      document.add(sep1); 
						 ...
						 * 
						 * Cell cel = new Cell("Quantit�"); cell.setHeader(true);
