 ...
 * @author User
 */
public class BookStatusEditJPanel extends javax.swing.JPanel{
     ...
     * @param bookStatus
     */
    public BookStatusEditJPanel(Window parent, BookStatus bookStatus) {
    ...
    private void initComponents() {
        ...
        fieldsPanelLayout.setHorizontalGroup(
            ...
            .addGroup(fieldsPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(postItPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    protected void initFields(){
        ...
        nameTextField.setText(bookStatus.getName());
        postItTextField.setText(bookStatus.getPostIt());
    }
    ...
    protected void confirmAction(){
        ...
        if(result == JOptionPane.YES_OPTION){
            bookStatus.setName(nameTextField.getText());
            bookStatus.setPostIt(postItTextField.getText());
            
            try {
                new BookStatusDAO().update(bookStatus);
            ...
            JOptionPane.showMessageDialog(
                        this, 
                        Strings.ELEMENT_BOOK_STATUS+" "+Strings.MSG_SUCCESSFULLY_EDITED, 
                        Strings.MSG_INFO, 
    ...
    protected void deleteAction(){
        ...
        if (result == JOptionPane.YES_OPTION) {
            ...
            try {
                new BookStatusDAO().delete(bookStatus);
            } catch (DatabaseException ex) {
                JOptionPane.showMessageDialog(
                        this, 
                        ex.getMessage(), 
            ...
            JOptionPane.showMessageDialog(
                        this, 
                        Strings.ELEMENT_BOOK_STATUS+" "+Strings.MSG_SUCCESSFULLY_DELETED, 
                        Strings.MSG_INFO, 
                        JOptionPane.INFORMATION_MESSAGE
            );
            notifyDatabaseListener();
